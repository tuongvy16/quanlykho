            ...
            <div style="margin-bottom:10px">
                <input id="ten" 
                       ...
                       data-options="required:true,
                                     ...
                                     missingMessage:'Vui lòng nhập tên khách hàng',
...
<div id="dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveKhachHang()" style="width:90px">Lưu</a>
